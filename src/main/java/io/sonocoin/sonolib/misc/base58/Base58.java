 ...
 */
package io.sonocoin.sonolib.misc.base58;
...
//        byte[] checksum = Sha256Hash.hashTwice(addressBytes, 0, payload.length + 1);
        byte[] checksum = Helpers.DHASH(addressBytes, 0, payload.length + 1);
...
//        byte[] actualChecksum = Arrays.copyOfRange(Sha256Hash.hashTwice(data), 0, 4);
        byte [] actualChecksum = Arrays.copyOfRange(Helpers.DHASH(data), 0, 4);
