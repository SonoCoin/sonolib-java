...
public class HD {
    ...
    public final static String Ed25519Curve = "Sonocoin seed";
    ...
    public HD(byte[] seed, int index) throws Exception {
        String path = "m/" + index + "\'";
        init(seed, path);
    }
    ...
    private void init(byte[] seed, String pathArgs) throws Exception {
